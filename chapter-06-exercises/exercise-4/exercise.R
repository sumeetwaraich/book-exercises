...
is_twice_as_long("chocolate", "oranges")
is_twice_as_long("oranges", "chocolate")
is_twice_as_long("blueberry", "chocolate")
is_twice_as_long("spider", "dog")
...
describe_difference("chocolate", "oranges")
describe_difference("oranges", "chocolate")
describe_difference("chocolate", "blueberry")
